...
var _touchEvent = __webpack_require__(6);
...
//page1手势事件
//moveY>0,上滑,反之下滑
(0, _touchEvent2.default)($page1Wrap, function () {
    if (isAnimate) return;
    isAnimate = true;
...
//page2事件
!function () {
    (0, _touchEvent2.default)($page2Wrap, null, function () {
        if (isAnimate) return;
        isAnimate = true;
...
!function () {
    ...
    (0, _touchEvent2.default)($page3Wrap, function ($event) {
        if (isAnimate) return;
        isAnimate = true;
...
!function () {
    ...
    (0, _touchEvent2.default)($page4Wrap, function ($event) {
        if (isAnimate) return;
        isAnimate = true;
        if (n < 2) {
            distance += 500;
...
//page5手势事件
!function () {
    (0, _touchEvent2.default)($page5Wrap, function ($event) {
        if (isAnimate) return;
        isAnimate = true;
...
!function () {
    ...
    (0, _touchEvent2.default)($page6Wrap, null, function ($event) {
        if (isAnimate) return;
        isAnimate = true;
...
function bindTouchEvent($element, slideUpHandler, slideDownHandler) {
    var startY = void 0; //开始坐标
    var moveY = void 0; //手指一动距离
...
exports.default = bindTouchEvent;
