...
var _jqueryImgpreload = __webpack_require__(6);
...
var _preloadList = __webpack_require__(8);

var _temp = __webpack_require__(9);
...
var _velocity = __webpack_require__(22);
...
var Pages = function Pages(parms) {
    ...
    function touchEnd(event) {
        ...
        (0, _velocity2.default)(wrap2, { translateY: -startPage * 14.29 + '%' }, {
            duration: 300,
            easing: 'linear',
...
function bindEvent() {
    var $page6 = (0, _jquery2.default)('.page6'),
        $page7 = (0, _jquery2.default)('.page7'),
        $page6Dialog = (0, _jquery2.default)('.page6-dialog'),
        $page7Dialog = (0, _jquery2.default)('.page7-dialog'),
        $professorBtn = (0, _jquery2.default)('.page6>.content5'),
        $page7ConfirmBtn = (0, _jquery2.default)('.page7 img[alt=button1]'),
        $page7ShareBtn = (0, _jquery2.default)('.page7 img[alt=button2]'),
        $page6DialogCloseBtn = (0, _jquery2.default)('.page6-dialog img[alt=close]'),
        $page7DialogBackBtn = (0, _jquery2.default)('.page7-dialog img[alt=back]'),
        $page7DialogConfirmBtn = (0, _jquery2.default)('.page7-dialog img[alt=confirm]'),
        $answer1YesRadio = (0, _jquery2.default)('.page7-dialog .answer1 input[id=yes]'),
        $answer1NoRadio = (0, _jquery2.default)('.page7-dialog .answer1 input[id=no]'),
        $answer2 = (0, _jquery2.default)('.page7-dialog .answer2');
    ...
    $page7DialogConfirmBtn.on('click', function () {
        var $page7DialogInputs = (0, _jquery2.default)('.page7-dialog input:checked,.page7-dialog input[type=text]');
