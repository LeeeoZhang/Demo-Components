...
var _eleAnimate = __webpack_require__(5);

var _initMusic = __webpack_require__(6);

var _drawPic = __webpack_require__(7);
...
$window.scroll(function () {
    ...
    timer1 = setTimeout(function () {
        ...
        (0, _eleAnimate.bindEleAnimate)($eleList, windowHeight, scrollTop);
    }, 150);
});
...
exports.bindEleAnimate = bindEleAnimate;
...
function initMusic($wrap) {
    var $musicWrap = $('<div class="bgm play"></div>');
    var $music = $('<audio loop></audio>');
...
function drawPic() {
    ...
    function clearCanvas(ctx, canvasWidth, canvasHeight, callback) {
        //启动函数
        function action() {
            var id = requestAnimationFrame(action);
            var result = TWEEN.update();
            if (!result) cancelAnimationFrame(id);
        }

        var r = { r: 0 //初始半径
        };var tween = new TWEEN.Tween(r).to({ r: canvasWidth }, 2000) //目标半径
    ...
    !function () {
        var $temple = $('.temple');
        var templeCtx = $temple[0].getContext('2d');
        var $xianglu = $('.xianglu');
        var canvasHeight = $temple[0].height;
        var canvasWidth = $temple[0].width;

        var templeImg = new Image();
    ...
    //岳麓书院
    !function () {
        var $yuelushuyuan = $('.yuelushuyuan');
        var yuelushuyuanCtx = $yuelushuyuan[0].getContext('2d');
        var canvasHeight = $yuelushuyuan[0].height;
        var canvasWidth = $yuelushuyuan[0].width;

        var yuelushuyuanImg = new Image();
        ...
        $yuelushuyuan.one('click', function () {
            clearCanvas(yuelushuyuanCtx, canvasWidth, canvasHeight, function () {
                var $yuelushuyuanTip = $('.yuelushuyuan-tip');
    ...
    !function () {
        var $school = $('.school');
        var schoolCtx = $school[0].getContext('2d');
        var canvasHeight = $school[0].height;
        var canvasWidth = $school[0].width;
        var $flag = $('.page3-wrap > .flag');
        ...
        $flag.one('click', function () {
            ...
            clearCanvas(schoolCtx, canvasWidth, canvasHeight, function () {
                var $diyishifanTip = $('.diyishifan-tip');
