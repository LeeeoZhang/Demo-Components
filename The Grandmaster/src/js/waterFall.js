...
export default function Waterfall($waterFallCt,$loadButtom) {
...
Waterfall.prototype.renderPage = function($node) {
...
Waterfall.prototype.makeNode = function() {
...
Waterfall.prototype.makeDate = function() {
    let urlArray =[]
    for(let i = 0; i<this.length; i++) {
        urlArray.push({
            post: `images/pic${this.postNum}.jpg`,
            minPost: `images/min_pic${this.postNum}.png`
        })
        this.postNum++
    }
    return urlArray
